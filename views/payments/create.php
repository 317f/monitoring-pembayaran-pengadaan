...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="index.php?page=payments&action=create" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <!-- Informasi Vendor -->
                <div class="row mb-4">
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kontak_vendor" name="kontak_vendor">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nomor_spk" name="nomor_spk" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_terbit_spk" name="tanggal_terbit_spk" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_akhir_spk" name="tanggal_akhir_spk" required>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control currency-input" id="nilai_kontrak" name="nilai_kontrak" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_termin" name="jumlah_termin" min="1">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="pembayaran_termin_ke" class="form-label">Pembayaran Termin Ke-</label>
                            <input type="number" class="form-control" id="pembayaran_termin_ke" name="pembayaran_termin_ke" min="1">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pic_divisi" name="pic_divisi">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="pic_vendor" class="form-label">PIC Vendor</label>
                            <input type="text" class="form-control" id="pic_vendor" name="pic_vendor">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="pic_draft_pks" class="form-label">PIC Draft PKS</label>
                            <input type="text" class="form-control" id="pic_draft_pks" name="pic_draft_pks">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="opini_verifikator" name="opini_verifikator" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
